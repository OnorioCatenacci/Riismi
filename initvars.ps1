$env:RMI_DATABASE="riismi"
$env:RMI_DBUSER="postgres"
$env:RMI_DBPWD="postgres"

$env:RMI_DATA_PATH="data/"
$env:RMI_PROCESSEDFILE_PATH="data/processed"
$env:RMI_LOGGER_LEVEL="info"
